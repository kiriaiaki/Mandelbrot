...
int Mandelbrot (float C_Re, float C_Im);
...
int main ()
{
    ...
    while (!WindowShouldClose())
    {
        ...
        for (int y = 0; y < SCREEN_VERTICAL; y++)
        {
            ...
            {
                float C_Re = Left_Bottom_X + x * Scale;
                float C_Im = Left_Bottom_Y + y * Scale;

                int Iteration = Mandelbrot(C_Re, C_Im);
                ...
                Pixels[(y * SCREEN_HORIZONTAL) + x] = (Color) {
                                                                (byte_k) Gray,
                                                                (byte_k) Gray,
                                                                (byte_k) Gray,
                                                                255
...
int Mandelbrot (float C_Re, float C_Im)
{
    ...
    {
        float Z_mod_pow_2 = (Z_n_Re * Z_n_Re) + (Z_n_Im * Z_n_Im);
        ...
        float Z_n_1_Re = (Z_n_Re * Z_n_Re) - (Z_n_Im * Z_n_Im) + C_Re;
        float Z_n_1_Im = (2.0f * Z_n_Re * Z_n_Im) + C_Im;
